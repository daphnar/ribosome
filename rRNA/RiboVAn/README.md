...
#
## Notes
1) If your run is a single-end run, run:

python RiboVAn.py file_1.ribo.atlas_mapped.sam False output
#
2) If you want to use RiboVAn for long-read sequencing data, I suggest splitting the long-reads to short-reads of 150 bases long. 
